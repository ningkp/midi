	...
	with tf.Session() as sess:
	    ...
	    with sess.graph.as_default():
	        with sess.graph.device(device_for_node):
				...
				with open('w_layer1.pik','wb')as f:
					pickle.dump(sess.run(w_layer1),f,-1)

				with open('w_layer2.pik','wb')as f2:
					pickle.dump(sess.run(w_layer2),f2,-1)

				with open('w_layer3.pik','wb')as f3:
					pickle.dump(sess.run(w_layer3),f3,-1)

				with open('w_layer4.pik','wb')as f4:
					pickle.dump(sess.run(w_layer4),f4,-1)

				with open('w_layer5.pik','wb')as f5:
					pickle.dump(sess.run(w_layer5),f5,-1)

				with open('w_layer6.pik','wb')as f6:
					pickle.dump(sess.run(w_layer6),f6,-1)

				with open('b_layer1.pik','wb')as f7:
					pickle.dump(sess.run(b_layer1),f7,-1)

				with open('b_layer2.pik','wb')as f8:
					pickle.dump(sess.run(b_layer2),f8,-1)

				with open('b_layer3.pik','wb')as f9:
					pickle.dump(sess.run(b_layer3),f9,-1)

				with open('b_layer4.pik','wb')as f10:
					pickle.dump(sess.run(b_layer4),f10,-1)

				with open('b_layer5.pik','wb')as f11:
					pickle.dump(sess.run(b_layer5),f11,-1)

				with open('b_layer6.pik','wb')as f12:
					pickle.dump(sess.run(b_layer6),f12,-1)
